...
import { BarChart3, CalendarClock, Dumbbell, Home, UserCircle } from 'lucide-react-native';
...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="analytics" options={{ title: t('analytics'), tabBarIcon: ({ color }) => <BarChart3 color={color} size={22} /> }} />
