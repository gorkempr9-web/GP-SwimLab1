...
export const competitionGuides: AcademyItem[] = [
  ...
  { id: 'tyf-portal-guide', section: 'competition', title: 'TYF Portal ne için kullanılır?', description: 'Resmi yarış başvuruları, lisans ve kulüp işlemleri için kullanılan federasyon portalıdır.', example: 'GP SwimLab sadece resmi TYF sayfalarına yönlendirme sağlar.' },
